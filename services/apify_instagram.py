...
def scrape_instagram_data(instagram_id,all_posts=False):
    """
    instagram_id: str ( id of instagram )
    all_posts: bool  ( default: False )
    """
    ...
    if all_posts:
        ...
        print("scraping with fast method !")
        ...
        return results[0]["latestPosts"]

if __name__ == "__main__":
    instagram_id = "nike"  # Replace with the desired Instagram profile ID
